...
const UpdateNotice = () => {
  ...
  return (
    ...
    >
      <DialogContent
        className="bg-secondary border-border text-foreground max-w-lg"
            ...
            {status.compare_url && (
              <>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-sky-700 underline hover:text-sky-700"
                >
                  See what changed
                </a>
                .
          ...
          <Collapsible>
            ...
            <CollapsibleContent className="pt-2">
              <div className="flex items-start gap-2">
                <code className="min-w-0 flex-1 px-2 py-1.5 rounded bg-card text-sky-700 text-xs break-all whitespace-pre-wrap">
                ...
                <Button
                  ...
                  onClick={copyCommand}
                  title="Copy command"
                  className="shrink-0 bg-card border-border text-foreground hover:bg-muted"
                >
          ...
          <div className="flex items-center justify-between gap-3 pt-1">
            <label className="flex items-center gap-2 text-sm text-muted-foreground">
              <Checkbox
                ...
                className="border-border data-[state=checked]:bg-muted data-[state=checked]:text-foreground"
              />
              Don't ask me again
            </label>
