...
const ImportModelModal: React.FC<Props> = ({ open, onOpenChange, onImported }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-card border-border text-foreground sm:max-w-[520px] p-8">
        <DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="flex gap-3 justify-center pt-2">
            <Button
              ...
              className="bg-nori-h8ab135 hover:bg-nori-h799c2a text-white dark:text-neutral-900 px-8 disabled:opacity-40"
            >
              {submitting ? (
            ...
            <Button
              ...
              variant="outline"
              className="border-border px-8 text-muted-foreground bg-card hover:bg-secondary"
            >
              Cancel
            </Button>
          </div>
